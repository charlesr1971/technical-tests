...
Description: takes 3 arguments with integer values and converts them into a factorial number sequence
Date: 03.02.10
Comments: 
Language: CFScript --->
...
<TR VALIGN="top">
<TD COLSPAN="2" STYLE="color:#000000;font-family:Arial;font-size:11px;font-weight:bold;border:1px solid #838383;" BGCOLOR="#C0C0C0" ALIGN="center"><FONT FACE="Arial"><B>Factorial number sequencer</B></FONT></TD>
</TR>
<TR VALIGN="top">
...
<TD STYLE="color:#000000;font-family:Arial;font-size:11px;font-weight:normal;text-align:left;" BGCOLOR="#E2E2E2"><FONT FACE="Arial">takes 3 arguments with integer values and converts them into a factorial number sequence</FONT></TD>
</TR>
<TR VALIGN="top">
...
<CFLOOP INDEX="i" FROM="1" TO="#ArrayLen(cfVar)#">
<TR VALIGN="top">
<TD WIDTH="150" STYLE="color:#000000;font-family:Arial;font-size:11px;font-weight:normal;"><CFOUTPUT>#cfVar[i]#<BR></CFOUTPUT></TD>
<TD WIDTH="50">&nbsp;</TD>
</TR>
</CFLOOP>
</TABLE></FONT></TD>
...
<CFSET CFFunctionheadcoreCode = HTMLCodeFormat('<CFFUNCTION NAME="numberSequencer" RETURNTYPE="array" OUTPUT="true" ACCESS="public">
<CFARGUMENT NAME="argN" TYPE="numeric" REQUIRED="yes">
<CFARGUMENT NAME="argM" TYPE="numeric" REQUIRED="yes">
<CFARGUMENT NAME="argEnd" TYPE="numeric" REQUIRED="yes">')>
...
<CFSET CFFunctionfootcoreCode = HTMLCodeFormat('<CFRETURN sequence>
</CFFUNCTION>')>
