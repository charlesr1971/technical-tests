...
<TITLE>numberSequencer: recursive</TITLE>
...
Description: takes 3 arguments with integer values and converts them into a Fibonacci number sequence, using a recursive function
Date: 03.02.10
Comments: 
Language: CFScript --->
...
function fib(n,m,end){
if(n LT 2){
return fib(n+1,m,end);
}
else if(n LT end){
return fib(n-1,m,end) + fib(n-2,m,end);
}
return n;
}
...
<CFIF FORM.end GT 1>
<CFSET cfVar = fib(1,1,FORM.end)>
<CFELSE>
<CFSET cfVar = fib(1,1,21)>
</CFIF>
<CFELSE>
<CFSET cfVar = fib(1,1,21)>
</CFIF>
...
<TR VALIGN="top">
<TD COLSPAN="2" STYLE="color:#000000;font-family:Arial;font-size:11px;font-weight:bold;border:1px solid #838383;" BGCOLOR="#C0C0C0" ALIGN="center"><FONT FACE="Arial"><B>Fibonacci number sequencer: recursive</B></FONT></TD>
</TR>
<TR VALIGN="top">
